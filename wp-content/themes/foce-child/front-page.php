...
?>
    ...
    <main id="primary" class="site-main">
        ...
        <section id="studio">
                ...
                <h2>
                <div id="h2studio" class="scroll-fade-in">Studio <span class="title-none">Koukaki</span></div>
                <div id="h2koukaki" class="scroll-fade-in"><span class="title-none">Studio</span> Koukaki</div>
                </h2>
